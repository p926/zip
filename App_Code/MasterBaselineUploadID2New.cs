...
/// <summary>
/// Summary description for MasterBaselineUploadID2New
/// </summary>
public class MasterBaselineUploadID2New
{
    private const string NEWDEVICE_GROUP = "PRECALAPP";
    private const string NEWDEVICE_STATUS = "Unknown";
    //private const int NEWDEVICE_PRODUCT = 39;                 // ID2    
    private const string NEWDEVICE_SKU = "INSTA ID2";           // ID2
    private const string NEWMATERIAL_SKU = "PCBA ID2";          // ID2
    ...
    public MasterBaselineUploadID2New(StreamReader pMasterFileContent, string pReceiptID)
    {        
    ...
    private bool MasterFileDataSchemaValidation()
    {
        ...
        try
        {
            ...
            if (masterParser.Data.Columns["Thick Detector"] == null) dataSchemaIsCorrect = false;
            if (masterParser.Data.Columns["Thin Detector"] == null) dataSchemaIsCorrect = false; 
    ...
    private bool MasterSerialNoFormatValidation()
    {
        ...
        try
        {
            ...
            foreach (DataRow masterRow in masterParser.Data.Rows)
            {
                ...
                if (Int32.Parse(serialNo) >= 50000000 || Int32.Parse(serialNo) < 40000000)
                {
                    string message = "Master file, S/N: " + serialNo + " is out of the format 4xxxxxxx.";
    ...
    {        
        try
        {
            ...
            string firmwareVersion = "0.572";     // ID2
            ...
            foreach (DataRow row in masterParser.Data.Rows)
            {
                ...
                string thickDetector = row["Thick Detector"] == null ? "" : row["Thick Detector"].ToString().Trim();
                string thinDetector = row["Thin Detector"] == null ? "" : row["Thin Detector"].ToString().Trim();
