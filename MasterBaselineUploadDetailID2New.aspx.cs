/*
 * ID2 New Instadose upload
 * 
 *  Created By: Tdo, 02/16/2017
...
public partial class TechOps_MasterBaselineUploadDetailID2New : System.Web.UI.Page
{
    ...
    MasterBaselineUploadID2New mbu;
    ...
    string UploadItemNumber = "PCBA ID2";
    ...
    private bool passInputsValidation()
    {
        ...
        mbu = new MasterBaselineUploadID2New(masterFileContent, this.ReceiptID);
    ...
    private void SendEmail(int pReceiptID, int pTotalUpload)
    {
        try
        {
            ...
            bodyText += "<font size='3'>There is " + pTotalUpload + " ID2 devices being uploaded to MAS on receipt#: " + pReceiptID + ".</font>";
