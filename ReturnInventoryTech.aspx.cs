...
public partial class TechOps_ReturnInventoryTech : System.Web.UI.Page
{
            ...
            foreach (string serialNumber in serialNumberList)
            {
                ...
                if (serialNumber.Trim() != "")
                {
                    ...
                    if (returnDevice != null)
                    {
                        ...
                        errorList.Add(serialNumber, "Badge has not received by Receiving Department.");
                    else if (returnInventory != null)    // It is showing device has already been RECEIVED and reviewed by Tech Ops.
                        errorList.Add(serialNumber, "Badge is already in Tech Ops' INV or Badge has not received by Receiving Department.");
