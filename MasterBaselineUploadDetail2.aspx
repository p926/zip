<%@ Page Title="Master Basline Upload Detail" Language="C#" MasterPageFile="~/masterpages/MirionDSD.master" AutoEventWireup="true" Inherits="TechOps_MasterBaselineUploadDetail2" Codebehind="MasterBaselineUploadDetail2.aspx.cs" %>
...
<asp:Content ID="Content6" ContentPlaceHolderID="primaryHolder" runat="Server">
    ...
    <div style="width:100%" >
        ...
        <div class="OForm" >
            ...
            <div class="Row" id="TempCompFileSection" runat = "server" >
                <div class="Label Large2">Temperature Comp. File <span class="Required">*</span>:</div>
                <div class="Control">
                    <asp:FileUpload ID="TempCompFile" runat="server" Width="400px" />                            
                </div>
                <div class="Clear"></div>
            </div>   
            
            <div class="Row" id="SensCoefFileSection" runat = "server" >
                <div class="Label Large2">Sensitivity Coef. File <span class="Required">*</span>:</div>
                <div class="Control">
                    <asp:FileUpload ID="SensCoefFile" runat="server" Width="400px" />                            
                </div>
                <div class="Clear"></div>
            </div>    
            
            <div class="Row" id="ReaderFileSection" runat = "server" >
                <div class="Label Large2">InstaLink File <span class="Required">*</span>:</div>
                <div class="Control">
                    <asp:FileUpload ID="ReaderFile" runat="server" Width="400px" />                            
                </div>
                <div class="Clear"></div>
            </div>                                                                        
