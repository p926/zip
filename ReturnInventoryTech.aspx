<%@ Page Language="C#" MasterPageFile="~/Masterpages/MirionDSD.master" AutoEventWireup="true" Inherits="TechOps_ReturnInventoryTech" Title="Receipt of Badges" Codebehind="ReturnInventoryTech.aspx.cs" %>
      ...
      <div >
            ...
            <asp:GridView ID="gvReview" runat="server" CssClass="OTable" 
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="DepartmentRequest" HeaderText="Department" ItemStyle-CssClass="mt-itm" HeaderStyle-CssClass="mt-hd"  ItemStyle-VerticalAlign="Top"/>
                    <asp:BoundField DataField="DeviveStatus" HeaderText="Status" ItemStyle-CssClass="mt-itm" HeaderStyle-CssClass="mt-hd"  ItemStyle-VerticalAlign="Top" />
                    <asp:BoundField DataField="Action" HeaderText="Action" ItemStyle-CssClass="mt-itm" HeaderStyle-CssClass="mt-hd"  ItemStyle-VerticalAlign="Top" />
          ...
          <div class="FormError" id="errorReviewEdit" runat="server" visible="false">
            ...
            <asp:GridView ID="gvReviewEdit" runat="server" CssClass="OTable" 
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="ReviewDate" HeaderText="Last Reviewed Date" ItemStyle-CssClass="mt-itm" HeaderStyle-CssClass="mt-hd"  ItemStyle-VerticalAlign="Top" />
                    <asp:TemplateField HeaderText="Notes" ItemStyle-CssClass="mt-itm" HeaderStyle-CssClass="mt-hd"  ItemStyle-VerticalAlign="Top" >
                        <ItemTemplate >   
