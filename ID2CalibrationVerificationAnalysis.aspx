<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/MirionDSD.master" AutoEventWireup="true" CodeBehind="ID2CalibrationVerificationAnalysis.aspx.cs" Inherits="portal_instadose_com_v3.TechOps.ID2CalibrationVerificationAnalysis" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="primaryHolder" Runat="Server">
    ...
    <div >
        <table class="OTable" >                                                
            <tr>
                <th colspan = "9" runat="server" id="Header" >Calibration Verification Pass/Fail Criteria</th>
            </tr>  
            <tr>
                <td style="width: 10%" >
                    <asp:Label ID="Label1" runat = "server" Text="DL Low Range:" />
                </td>
                <td class="mt-itm-bold LeftAlign" style="width: 10%" >
                    <asp:TextBox ID="txtDL_LR" runat = "server" Width ="60px" Enabled = "false" />
                </td>
                <td style="width: 10%">
                    <asp:Label ID="Label2" runat = "server" Text="DL High Range:"  />
                </td>
                <td class="mt-itm-bold leftalign " style="width: 10%">
                    <asp:TextBox ID="txtDL_HR" runat = "server"  Width ="60px" Enabled = "false" />
                </td>
                <td style="width: 10%" >
                    <asp:Label ID="Label3" runat = "server" Text="SL Low Range:" />
                </td>
                <td class="mt-itm-bold LeftAlign" style="width: 10%" >
                    <asp:TextBox ID="txtSL_LR" runat = "server"  Width ="60px" Enabled = "false" />
                </td>
                <td style="width: 10%">
                    <asp:Label ID="Label4" runat = "server" Text="SL High Range:"  />
                </td>
                <td class="mt-itm-bold leftalign " >
                    <asp:TextBox ID="txtSL_HR" runat = "server" Width ="60px" Enabled = "false" />
                </td>
    ...
    <div>
		...
		<asp:UpdatePanel ID="UpdatePanelCalibrationAnalysis" runat="server"  UpdateMode="Conditional">			
			<ContentTemplate>				

                <asp:GridView ID="grdCalibrationAnalysisView" CssClass="OTable"  runat="server" OnRowDataBound="grdCalibrationAnalysisView_RowDataBound">                    
