...
public partial class TechOps_MasterBaselineUploadDetail3 : System.Web.UI.Page
{
    ...
    private bool passInputsValidation()
    {
        ...
        mbu = new MasterBaselineUpload3(masterFileContent, this.ReceiptID);
                    ...
                    if (masterFileStreamReader.Peek() != -1)
                    {
                        ...
                        while (masterFileStreamReader.Peek() != -1)
                        {
                            ...
                            if (myLine.Length > 0)
                            {
                                ...
                                myItemNumber = "PCBA";     // It is for IMI Instadose 1
    ...
    private void SendEmail(int pReceiptID, int pTotalUpload)
    {
        try
        {
            ...
            bodyText += "<font size='3'>There is " + pTotalUpload + " IMI Instadose devices being uploaded to MAS on receipt#: " + pReceiptID + ".</font>";
